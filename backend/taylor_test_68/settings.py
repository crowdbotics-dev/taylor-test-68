"""
Django settings for taylor_test_68 project.
...
ROOT_URLCONF = 'taylor_test_68.urls'
...
WSGI_APPLICATION = 'taylor_test_68.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "taylor test Support <support@taylor-test-68.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taylor_test_68 API",
    "DESCRIPTION": "API documentation for taylor_test_68 App",
    "VERSION": "v1",
}
